 ...
 * @author frederic
 */
public class jtmAvailableMercenary  extends AbstractTableModel
{
    Vector _stars;
    
    public jtmAvailableMercenary(Vector stars)
    {
        _stars=stars;
    }
    ...
    {
        mPlayerType player=(mPlayerType)_stars.get(row);
         switch (col)
        {
            case 0:
