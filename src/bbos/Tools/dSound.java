...
{
    public static dSound sBLOCK=new dSound("/resources/sounds/block.ogg");
    public static dSound sBLUNDERBUSS=new dSound("/resources/sounds/blunder.ogg");
    public static dSound sBOO=new dSound("/resources/sounds/boo.ogg");
    public static dSound sBOUNCE=new dSound("/resources/sounds/bounce.ogg");
    public static dSound sCATCH=new dSound("/resources/sounds/catch.ogg");
    public static dSound sCHAINSAW=new dSound("/resources/sounds/chainsaw.ogg");
    public static dSound sCHEERLEADERS=new dSound("/resources/sounds/cheer.ogg");
    public static dSound sCLICK=new dSound("/resources/sounds/click.ogg");
    public static dSound sDING=new dSound("/resources/sounds/ding.ogg");
    public static dSound sDODGE=new dSound("/resources/sounds/dodge.ogg");
    public static dSound sEXPLODE=new dSound("/resources/sounds/explode.ogg");
    public static dSound sFALL=new dSound("/resources/sounds/fall.ogg");
    public static dSound sFIREBALL=new dSound("/resources/sounds/fireball.ogg");
    public static dSound sHURT=new dSound("/resources/sounds/gottahurt.ogg");
    public static dSound sINJURY=new dSound("/resources/sounds/injury.ogg");
    public static dSound sKICK=new dSound("/resources/sounds/kick.ogg");
    public static dSound sKO=new dSound("/resources/sounds/ko.ogg");
    public static dSound sLIGHTNING=new dSound("/resources/sounds/lightning.ogg");
    public static dSound sMETAL=new dSound("/resources/sounds/metal.ogg");
    public static dSound sPICKUP=new dSound("/resources/sounds/pickup.ogg");
    public static dSound sSI=new dSound("/resources/sounds/si.ogg");
    public static dSound sMOVE=new dSound("/resources/sounds/step.ogg");
    public static dSound sTOUCHDOWN=new dSound("/resources/sounds/td.ogg");
    public static dSound sTHROW=new dSound("/resources/sounds/throw.ogg");
    public static dSound sWHISTLE=new dSound("/resources/sounds/whistle.ogg");
	 ...
	 */
	protected dSound(String resource)
                //dSound(String pUrl)
	{
		//configureInputStream(getUrl(pUrl));
                configureInputStream(resource);
	}
	 ...
	 */
	private void configureInputStream(String resource)
